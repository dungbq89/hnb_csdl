 ...
 */
class csdlLoaigiaithuongAdminForm extends Basecsdl_loaigiaithuongForm {

    public function configure() {
        $i18n = sfContext::getInstance()->getI18N();
        unset($this['created_at'], $this['updated_at'], $this['created_at'], $this['updated_at']);
        $this->widgetSchema['tendanhmuc'] = new sfWidgetFormInputText(array());
        $this->validatorSchema['tendanhmuc'] = new sfValidatorString(array('required' => true, 'trim' => true, 'max_length' => 255));

        $this->widgetSchema['madanhmuc'] = new sfWidgetFormInputText(array());
        $this->validatorSchema['madanhmuc'] = new sfValidatorString(array('required' => true, 'trim' => true, 'max_length' => 255));
        ...
        $this->widgetSchema->setNameFormat('csdl_danhmuc[%s]');

...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            ...
            <div class="span12">
            <h1 style="display: inline"><?php echo __('Danh sách chủ đề', array(), 'messages') ?></h1>
            </div>
            <div class="">
                <div class="span9">
            ...
            <div id="sf_admin_content">
                                    <form class="form-inline" id="list-form" action="<?php echo url_for('csdl_chude_collection', array('action' => 'batch')) ?>" method="post">
                    ...
                    <div class="well pull-right">
                      <?php echo __('Số bản ghi/trang: ')?>
                        <?php $select = new sfWidgetFormChoice(array(
                                    ...
                                    array('class' => 'input-medium')); echo $select->render('max_per_page', $sf_user->getAttribute('csdlChude.max_per_page', null, 'admin_module')) ?>

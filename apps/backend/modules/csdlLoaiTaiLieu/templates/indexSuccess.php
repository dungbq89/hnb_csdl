...
<?php include_partial('csdlLoaiTaiLieu/assets') ?>
<?php include_partial('csdlLoaiTaiLieu/header') ?>
...
<div class="container-fluid">
    <div class="row-fluid">
        <?php if ($sidebar_status): ?>
            <?php include_partial('csdlLoaiTaiLieu/list_sidebar', array('configuration' => $configuration)) ?>
        <?php endif; ?>
        ...
        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">
            ...
            <div id="sf_admin_content">
                ...
                <div>
                    <div class="well pull-left margin-right">
                        <?php include_partial('csdlLoaiTaiLieu/list_actions', array('helper' => $helper)) ?>
                    </div>
                    <?php include_partial('csdlLoaiTaiLieu/list_batch_actions', array('helper' => $helper)) ?>
                </div>
                                    </form>
                
                <form class="form-inline" method="get" action="<?php echo url_for('csdl_loaitailieu') ?>">
                    <div class="well pull-right">
                      <?php echo __('Số bản ghi/trang: ')?>
                        <?php $select = new sfWidgetFormChoice(array(
                                    ...
                                    array('class' => 'input-medium')); echo $select->render('max_per_page', $sf_user->getAttribute('csdlLoaiTaiLieu.max_per_page', null, 'admin_module')) ?>
            ...
            <?php include_partial('csdlLoaiTaiLieu/list_footer', array('pager' => $pager)) ?>
        </div>
    </div>
</div>

<?php include_partial('csdlLoaiTaiLieu/footer') ?>
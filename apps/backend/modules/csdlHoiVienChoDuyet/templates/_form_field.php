<?php if ($field->isPartial()): ?>
    <?php include_partial('csdlHoiVienChoDuyet/'.$name, array('csdl_lylichhoivien' => $csdl_lylichhoivien, 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
<?php elseif ($field->isComponent()): ?>
    <?php include_component('csdlHoiVienChoDuyet', $name, array('form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
<?php else: ?>
